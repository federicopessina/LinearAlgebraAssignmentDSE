...
```{r}
asn <- initialDistribution * mcEpidemics
...
The number of individuals in each state is calculated throough the **expected value** - probability of being in a particular state times the total number of individuals
