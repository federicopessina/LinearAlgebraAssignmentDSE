...
linear_equation1 <- c(2, 5, 1)
linear_equation2 <- c(5, 2, 3)
linear_equation3 <- c(8, 3, 2)
...
Then we add -5 times the 1st row to the 2nd row `E[1,]`:
...
We add -1 times the 1st row to the 3rd row: 
...
We multiply the 2nd row by -2/21:
...
>>>>>>> 6a74b132b76507451874a35bc1cbcaae23535b50:02.Reports/01. Group 4.Rmd
